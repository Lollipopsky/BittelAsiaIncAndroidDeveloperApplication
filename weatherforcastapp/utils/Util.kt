...
object Util {
    ...
    fun getWeatherInfo(code: Int): WeatherInfoItem {
        return when (code) {
            ...
            51, 53, 55 -> WeatherInfoItem("Drizzle", R.drawable.drizzle)
            56, 57 -> WeatherInfoItem("Freezing Drizzle", R.drawable.freezing_drizzle)
            61 -> WeatherInfoItem("Rain: Slight", R.drawable.rain_slight)
            ...
            else -> WeatherInfoItem("Unknown", R.drawable.clear_sky) // Default case
        }
    }
